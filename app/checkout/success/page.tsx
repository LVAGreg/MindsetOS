      ...
      <div className="max-w-2xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-lg text-gray-600">
            Welcome to the Client Fast Start. Let&apos;s get you set up.
          </p>
        </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600 mb-3">
                All 14+ AI agents are now fully accessible — Money Model Mapper, Offer Invitation Architect,
                Presentation Printer, LinkedIn Events Builder, MindsetAI, and more. They&apos;re trained on the exact frameworks inside Client Fast Start.
              </p>
              <Link
                href="/dashboard"
            ...
            <div className="flex-1">
              ...
              <div className="space-y-1.5 mb-4">
                {[
                  ...
                  'Templates, frameworks, and workbooks',
