      ...
      >
        ...
        <div className="max-w-none space-y-6" style={{ color: '#9090a8' }}>
          ...
          <section>
            <p>
              ...
              located at <a href="https://mindset.show" className="font-medium hover:opacity-80 transition-opacity" style={{ color: '#fcc824' }}>https://mindset.show</a>.
            </p>
            <p className="mt-4">
          ...
          {/* AI Services */}
          <section>
            <h2 className="text-2xl font-bold mt-8 mb-4" style={{ color: '#ededf5' }}>AI-Powered Services</h2>
            <p>
            ...
            <h3 className="text-xl font-bold mt-6 mb-3" style={{ color: '#ededf5' }}>AI Output Limitations &amp; Disclaimers</h3>
            <ul className="list-disc pl-6 space-y-2">
              <li><strong style={{ color: '#ededf5' }}>Informational Purposes Only</strong>: All AI-generated content is provided for informational and mindset coaching purposes only and should not be relied upon as professional, legal, financial, medical, or tax advice</li>
              <li><strong style={{ color: '#ededf5' }}>No Warranty</strong>: We make no representations or warranties regarding the accuracy, completeness, reliability, or suitability of AI-generated content for any purpose</li>
              <li><strong style={{ color: '#ededf5' }}>User Responsibility</strong>: You are solely responsible for reviewing, validating, and verifying all AI-generated recommendations before implementing them in your business</li>
              <li><strong style={{ color: '#ededf5' }}>Human Oversight Required</strong>: AI outputs require human review and should not be used as the sole basis for business, legal, or financial decisions</li>
              <li><strong style={{ color: '#ededf5' }}>Potential Errors</strong>: AI systems may produce inaccurate, incomplete, outdated, or misleading information (commonly known as "hallucinations")</li>
            </ul>

            <h3 className="text-xl font-bold mt-6 mb-3" style={{ color: '#ededf5' }}>Third-Party AI Models &amp; Dependencies</h3>
            <ul className="list-disc pl-6 space-y-2">
              <li><strong style={{ color: '#ededf5' }}>External AI Providers</strong>: Our service utilizes third-party AI models (including but not limited to OpenAI, Anthropic, and Perplexity) which are subject to their respective terms of service</li>
              <li><strong style={{ color: '#ededf5' }}>Model Availability</strong>: We do not guarantee continuous availability of any specific AI model and reserve the right to change, update, or discontinue models at any time</li>
              <li><strong style={{ color: '#ededf5' }}>Third-Party Limitations</strong>: We are not responsible for errors, limitations, downtime, or changes made by third-party AI providers</li>
              <li><strong style={{ color: '#ededf5' }}>API Dependencies</strong>: Service functionality depends on third-party APIs which may experience interruptions, rate limits, or performance degradation beyond our control</li>
            </ul>

            <h3 className="text-xl font-bold mt-6 mb-3" style={{ color: '#ededf5' }}>Intellectual Property &amp; Content Ownership</h3>
            <ul className="list-disc pl-6 space-y-2">
              <li><strong style={{ color: '#ededf5' }}>Your Content Ownership</strong>: You retain ownership of content you input into the system and content you create with AI assistance</li>
              <li><strong style={{ color: '#ededf5' }}>License Grant</strong>: You grant MindsetOS a worldwide, non-exclusive, royalty-free license to use, reproduce, modify, and distribute your content for purposes of service improvement, AI model training, and platform functionality</li>
              <li><strong style={{ color: '#ededf5' }}>AI Training Data</strong>: Your conversations and interactions may be used to improve AI models and service quality, subject to our Privacy Policy</li>
              <li><strong style={{ color: '#ededf5' }}>No Ownership of AI Outputs</strong>: AI-generated content may not be unique and similar outputs may be generated for other users</li>
            </ul>

            <h3 className="text-xl font-bold mt-6 mb-3" style={{ color: '#ededf5' }}>Prohibited AI Uses</h3>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <h3 className="text-xl font-bold mt-6 mb-3" style={{ color: '#ededf5' }}>Limitation of Liability for AI Services</h3>
            <p>
              <strong style={{ color: '#ededf5' }}>TO THE MAXIMUM EXTENT PERMITTED BY LAW</strong>, MindsetOS shall not be liable for any damages arising from:
            </p>
            ...
            <h3 className="text-xl font-bold mt-6 mb-3" style={{ color: '#ededf5' }}>User Indemnification</h3>
            <p>
          ...
          {/* Cookies */}
          <section>
            <h2 className="text-2xl font-bold mt-8 mb-4" style={{ color: '#ededf5' }}>Cookies</h2>
            <p>
          ...
          {/* License */}
          <section>
            <h2 className="text-2xl font-bold mt-8 mb-4" style={{ color: '#ededf5' }}>License</h2>
            <p>
            ...
            <p className="font-semibold mt-4" style={{ color: '#ededf5' }}>You must not:</p>
            <ul className="list-disc pl-6 space-y-2 mt-2">
          ...
          {/* User Content */}
          <section>
            <h2 className="text-2xl font-bold mt-8 mb-4" style={{ color: '#ededf5' }}>User Content &amp; Comments</h2>
            <p>
            ...
            <p className="font-semibold mt-4" style={{ color: '#ededf5' }}>You warrant and represent that:</p>
            <ul className="list-disc pl-6 space-y-2 mt-2">
          ...
          {/* Data Usage */}
          <section>
            <h2 className="text-2xl font-bold mt-8 mb-4" style={{ color: '#ededf5' }}>Data Usage &amp; Privacy</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold mt-8 mb-4" style={{ color: '#ededf5' }}>Coaching &amp; Support Access</h2>
            <p>
            ...
            <ul className="list-disc pl-6 space-y-2 mt-2">
              <li><strong style={{ color: '#ededf5' }}>Coach Portal Access</strong>: Your assigned coach or support team member may access your MindsetOS account during scheduled coaching sessions to provide guidance, review your progress, and assist with agent configurations</li>
              <li><strong style={{ color: '#ededf5' }}>View-Only by Default</strong>: Coach access is view-only unless you explicitly grant edit permissions during a session</li>
              <li><strong style={{ color: '#ededf5' }}>Session-Based</strong>: Coach access is limited to active coaching sessions and does not persist indefinitely. Access is revoked when the session ends</li>
              <li><strong style={{ color: '#ededf5' }}>Confidentiality</strong>: Coaches are bound by confidentiality obligations and will not share, distribute, or use your data outside the scope of your coaching engagement</li>
              <li><strong style={{ color: '#ededf5' }}>Notification</strong>: You will be notified when a coach accesses your portal, and you may end the session at any time</li>
              <li><strong style={{ color: '#ededf5' }}>Opt-Out</strong>: You may request to opt out of coach portal access by contacting support, though this may limit the effectiveness of coaching sessions</li>
            </ul>
          </section>

          {/* Payment & Billing */}
          <section>
            <h2 className="text-2xl font-bold mt-8 mb-4" style={{ color: '#ededf5' }}>Payment &amp; Billing</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold mt-8 mb-4" style={{ color: '#ededf5' }}>Service Availability</h2>
            <p>
          ...
          {/* Prohibited Uses */}
          <section>
            <h2 className="text-2xl font-bold mt-8 mb-4" style={{ color: '#ededf5' }}>Prohibited Uses</h2>
            <p className="font-semibold" style={{ color: '#ededf5' }}>You may not use MindsetOS to:</p>
            <ul className="list-disc pl-6 space-y-2 mt-2">
          ...
          {/* Hyperlinking */}
          <section>
            <h2 className="text-2xl font-bold mt-8 mb-4" style={{ color: '#ededf5' }}>Hyperlinking to Our Content</h2>
            <p>
          ...
          {/* Content Liability */}
          <section>
            <h2 className="text-2xl font-bold mt-8 mb-4" style={{ color: '#ededf5' }}>Content Liability</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold mt-8 mb-4" style={{ color: '#ededf5' }}>Reservation of Rights</h2>
            <p>
          ...
          {/* Disclaimer */}
          <section>
            <h2 className="text-2xl font-bold mt-8 mb-4" style={{ color: '#ededf5' }}>Disclaimer</h2>
            <p>
            ...
            <p className="mt-4 font-semibold" style={{ color: '#ededf5' }}>Nothing in this disclaimer will:</p>
            <ul className="list-disc pl-6 space-y-2 mt-2">
          ...
          {/* Governing Law */}
          <section>
            <h2 className="text-2xl font-bold mt-8 mb-4" style={{ color: '#ededf5' }}>Governing Law</h2>
            <p>
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:hello@mindset.show" className="font-medium hover:opacity-80 transition-opacity" style={{ color: '#fcc824' }}>
                hello@mindset.show
              </a>
            </p>
          </section>
        ...
        <div className="mt-12 pt-6 border-t" style={{ borderColor: '#1e1e30' }}>
          <div className="flex flex-wrap gap-4 justify-center text-sm">
            ...
            <Link href="/privacy" className="hover:opacity-80 transition-opacity" style={{ color: '#fcc824' }}>
              Privacy Policy
            </Link>
