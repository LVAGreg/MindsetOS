...
const WORKFLOW_STAGES = [
  ...
  },
  {
    ...
    agents: [
      ...
      { name: 'Authority Engine', icon: '👑', desc: 'Position yourself as the go-to authority' },
    ],
  },
  {
    phase: 'Events',
...
const STATS = [
  { value: '87+', label: 'Active Coaches', sublabel: 'building with MindsetOS' },
  { value: '14', label: 'Mindset AI Agents', sublabel: 'working for you 24/7' },
  { value: '30%', label: 'Avg. Conversion', sublabel: 'from lead to client' },
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8">
          <div className="max-w-4xl">
            ...
            <h1 className="anim-float-1 text-[2.75rem] sm:text-6xl lg:text-7xl font-black leading-[1.05] tracking-tight mb-6">
              Your mindset coaching offer,{' '}
              <br className="hidden sm:block" />
              built by{' '}
              <span className="shimmer-text">14 AI agents</span>
              <br className="hidden sm:block" />
              in one sitting.
            </h1>
            ...
            <p className="anim-float-2 text-lg sm:text-xl text-gray-500 dark:text-gray-400 max-w-2xl leading-relaxed mb-10">
              MindsetOS walks you from &ldquo;I have expertise&rdquo; to &ldquo;I have paying clients&rdquo;
              — offer design, promotions, sales scripts, the works.
              Same frameworks used by 6-figure mindset coaches. Zero guesswork.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8">
          ...
          <div className="max-w-2xl mb-16">
            ...
            <p className="text-lg text-gray-500 dark:text-gray-400 leading-relaxed">
              14 specialized agents organized into 5 workflow stages. Each one handles a different
              piece of building your mindset coaching business — so you never start from scratch.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
            ...
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl font-black tracking-tight mb-8">
                Built for mindset coaches who are{' '}
              ...
              <div className="space-y-5">
                {[
                  ...
                  { icon: MessageSquare, title: 'Guidance', text: 'AI agents that walk you through each step. Not just text generators.' },
                ...
                <div className="relative">
                  ...
                  <div className="space-y-3 mb-8">
                    {[
                      ...
                      'All 14 Mindset AI agents unlocked',
      ...
      <section className="relative py-24 sm:py-32 bg-[#fcc824] overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-5 sm:px-8 text-center">
          <h2 className="text-3xl sm:text-5xl lg:text-6xl font-black tracking-tight text-black mb-6 leading-[1.1]">
            Stop building your business<br className="hidden sm:block" /> from scratch.
          </h2>
