...
const STATS = [
  { value: '87+', label: 'Active Entrepreneurs', sublabel: 'building with MindsetOS' },
  { value: '14', label: 'MindsetOS AI Agents', sublabel: 'working for you 24/7' },
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8">
          <div className="max-w-4xl">
            ...
            <p className="anim-float-2 text-lg sm:text-xl text-gray-500 dark:text-gray-400 max-w-2xl leading-relaxed mb-10">
              ...
              Same frameworks used by 6-figure entrepreneurs. Zero guesswork.
            </p>
